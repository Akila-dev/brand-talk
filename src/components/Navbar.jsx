...
const Navbar = ({ activeProp, setActiveProp }) => {
	...
	return (
		...
		>
			...
			<div className="hidden w-full px-3 md:px-5 rounded-[3rem] bg-white lg:grid grid-cols-5 shadow-card h-[65px] text-sm">
				<ul className="col-span-2 flex justify-end items-center nav-container">
				...
				<ul className="col-span-2 flex justify-start items-center nav-container">

...
const WorkDetail = ({
	...
	const left = useTransform(scrollYProgress, [0, 0.75], [-100, 0], {
		ease: cubicBezier(0.17, 0.57, 0.83, 0.57),
	});
	const right = useTransform(scrollYProgress, [0, 0.75], [100, 0], {
		ease: cubicBezier(0.17, 0.57, 0.83, 0.57),
	});
	const opacity = useTransform(scrollYProgress, [0, 0.75], [0.5, 1], {
		ease: cubicBezier(0.17, 0.57, 0.83, 0.57),
	});
	const scale = useTransform(scrollYProgress, [0, 0.75], [1.1, 1], {
		ease: cubicBezier(0.17, 0.57, 0.83, 0.57),
	});
